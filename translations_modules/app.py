optimized_app_translations = {
    ...
    'es': {
        'app_info': {
            'app_title': 'Conviértete en Dentista',
            'app_description': 'Plataforma profesional para la preparación del examen BIG para dentistas en los Países Bajos',
    ...
    'pt': {
        'app_info': {
            'app_title': 'Torne-se um Dentista',
            'app_description': 'Plataforma profissional para preparação do exame BIG para dentistas na Holanda',
    ...
    'uk': {
        'app_info': {
            'app_title': 'Стань Стоматологом',
            'app_description': 'Професійна платформа для підготовки до іспиту BIG для стоматологів у Нідерландах',
    ...
    'fa': {
        'app_info': {
            'app_title': 'دندانپزشک شوید',
            'app_description': 'پلتفرم حرفه‌ای برای آمادگی آزمون BIG برای دندانپزشکان در هلند',
    ...
    'tr': {
        'app_info': {
            'app_title': 'Tandarts Olun',
            'app_description': "Hollanda'daki diş hekimleri için BIG sınavına hazırlık platformu",
    ...
    'ar': {
        'app_info': {
            'app_title': 'كن طبيب أسنان',
            'app_description': 'منصة احترافية للتحضير لامتحان BIG لأطباء الأسنان في هولندا',
            'seo_title': 'التحضير لامتحان BIG لأطباء الأسنان في هولندا - كن طبيب أسنان',
            'seo_description': 'منصة على الإنترنت تُعد أطباء الأسنان لاجتياز امتحان تسجيل BIG (BI-toets) في هولندا. مواد دراسية واختبارات تدريبية ونصائح ومجتمع.',
            'professional_platform': 'منصة احترافية عبر الإنترنت لإعداد أطباء الأسنان لامتحان BIG والحصول على الترخيص في هولندا',
