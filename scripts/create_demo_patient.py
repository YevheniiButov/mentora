# scripts/create_demo_patient.py
...
def create_demo_scenario():
    ...
    try:
        # Use the application context manager to avoid the 'Working outside of application context' error
                ...
                scenario_data=json.dumps({
                    "default": {
                        ...
                        "dialogue_nodes": [
                            ...
                            {
                                "id": "bite_pain",
                                "patient_statement": "Yes, it hurts a lot when I chew on that side. It feels like the tooth is too high.",
                                "patient_emotion": "concerned",
                                "options": [
                                    {
                                        "text": "Let me check your bite with articulating paper.",
                                    ...
                                    {
                                        "text": "I think I understand the problem. I need to adjust the height of your filling.",
                                        "next_node": "treatment",
                                        "score": 10
                                    },
                                    {
                                        "text": "Let's take an X-ray to rule out other issues.",
                                        "next_node": "xray",
                                        "score": 0
                                    }
                                ]
                    ...
                    "translations": {
                        "ru": {
                            ...
                            "dialogue_nodes": [
                                ...
                                {
                                    "id": "bite_pain",
                                    "patient_statement": "Да, очень болит, когда я жую на этой стороне. Ощущение, будто зуб слишком высокий.",
                                    "patient_emotion": "concerned",
                                    "options": [
                                        {
                                            "text": "Давайте проверим ваш прикус с помощью артикуляционной бумаги.",
                                        ...
                                        {
                                            "text": "Думаю, я понимаю проблему. Мне нужно скорректировать высоту вашей пломбы.",
                                            "next_node": "treatment",
                                            "score": 10
                                        },
                                        {
                                            "text": "Сделаем рентген, чтобы исключить другие проблемы.",
                                            "next_node": "xray",
                                            "score": 0
                                        }
                                    ]
