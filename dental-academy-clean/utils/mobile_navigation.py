    ...
    def generate_breadcrumbs(cls, request, lang, custom_items=None):
        ...
        if 'learning' in endpoint or 'module' in endpoint or 'lesson' in endpoint or 'subject' in endpoint:
            ...
            breadcrumbs.append({
                ...
                'url': url_for('virtual_patient.list_scenarios', lang=lang)
            })
...
def get_active_nav_item(endpoint):
    ...
    endpoint_mapping = {
        ...
        # Virtual Patients
        'virtual_patient.list_scenarios': 'patients',
        'virtual_patient.interact': 'patients',
        'virtual_patient.scenario_detail': 'patients',
