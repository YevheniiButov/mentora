#!/usr/bin/env python3
"""
Упрощенный скрипт для создания темы-голосования о уровнях нидерландского языка
Работает с существующими таблицами форума
"""
...
def create_demo_user(cur, username):
    """Создать демо-пользователя для голосования"""
    user_data = {
...
if __name__ == "__main__":
    print("🇳🇱 СОЗДАНИЕ ГОЛОСОВАНИЯ О НИДЕРЛАНДСКОМ ЯЗЫКЕ")
    print("=" * 50)
