...
class Config:
    ...
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME', 'temporary-username')
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD', 'temporary-password')
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER', 'Mentora <noreply@mentora.com>')
