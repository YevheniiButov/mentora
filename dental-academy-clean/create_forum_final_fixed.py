#!/usr/bin/env python3
"""
Финальный исправленный скрипт для создания форума
Исправляет SQL синтаксис для PostgreSQL
"""
...
def create_forum_topics(conn, category_id):
    ...
    # Получаем пользователей для создания тем - ИСПРАВЛЕНО: используем одинарные кавычки
    ...
    for topic_data in topics_data:
        ...
        # Создаем тему с обязательными полями
        try:
            ...
            print(f"✅ Создана тема: {topic_title} (slug: {topic_slug}, ID: {topic_id})")
...
def main():
    """Основная функция"""
    print("🚀 ФИНАЛЬНЫЙ ИСПРАВЛЕННЫЙ СКРИПТ ФОРУМА")
    print("=" * 60)
