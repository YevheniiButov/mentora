#!/usr/bin/env python3
"""
Скрипт для поиска тем с вашим именем
"""
...
def find_your_topics():
    ...
    try:
        ...
        with app.app_context():
            ...
            # Находим все темы с вашим именем
            your_topics = ForumTopic.query.join(User).filter(
            ...
            admin_topics = ForumTopic.query.join(User).filter(
