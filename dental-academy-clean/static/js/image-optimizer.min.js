...
class ImageOptimizer {
    ...
    optimizeImages() {
        ...
        images.forEach(img => {
            // Skip images with no-optimize class or data attribute
            if (img.classList.contains('no-optimize') || img.hasAttribute('data-no-optimize')) {
                return;
            }
            
            // Skip QR codes
            if (img.src && (img.src.includes('qr_') || img.src.includes('/qr_codes/'))) {
                return;
            }
